...
const CourseCreate = (props) => (
  <Create {...props} title="Tạo khóa học mới">
    <SimpleForm>
      <TextInput 
        source="title" 
        label="Tên khóa học" 
      ...
      <BooleanInput source="is_published" label="Xuất bản ngay" />
      <BooleanInput source="is_featured" label="Đánh dấu nổi bật" />
      
      <ArrayInput source="sections" label="Phần học" validate={required()}>
        <SimpleFormIterator>
          <TextInput 
            source="title" 
            label="Tiêu đề phần" 
          ...
          <ArrayInput source="lessons" label="Bài học" validate={required()}>
            <SimpleFormIterator>
              <TextInput 
                source="title" 
                label="Tiêu đề bài" 
              ...
              <ArrayInput source="quizzes" label="Quiz" validate={required()}>
                <SimpleFormIterator>
                  <TextInput 
                    source="question" 
                    label="Câu hỏi" 
